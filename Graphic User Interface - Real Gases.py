...
def GerarFatoresCompressibilidade(tfn_fc, lbrR_fc, tfT_fc, tfa_fc, tfb_fc, uV):
    ...
    plt.title("Compressibility Factor Z(V)")
...
lbUnidades_rk = Label(frRedlichKwong, text = "Select input units")

lbPU_rk = Label(frRedlichKwong, text = "Pressure")
...
lbnU_rk = Label(frRedlichKwong, text = "Moles")
mnn_rk = OptionMenu(frRedlichKwong, tkn_rk, *escolhasrk)
mnn_rk.config(width = 18)

lbTU_rk = Label(frRedlichKwong, text = "Temperature")
...
btCalcularRedlichKwong = Button(frRedlichKwong, text = "Calculate", width = 18)
...
lbUnidades_d = Label(frDieterici, text = "Select input units")

lbPU_d = Label(frDieterici, text = "Pressure")
...
lbnU_d = Label(frDieterici, text = "Moles")
mnn_d = OptionMenu(frDieterici, tkn_d, *escolhasd)
mnn_d.config(width = 18)

lbTU_d = Label(frDieterici, text = "Temperature")
...
btCalcularDieterici = Button(frDieterici, text = "Calculate", width = 18)
...
lbUnidades_b = Label(frBerthelot, text = "Select input units")

lbPU_b = Label(frBerthelot, text = "Pressure")
...
lbnU_b = Label(frBerthelot, text = "Moles")
mnn_b = OptionMenu(frBerthelot, tkn_b, *escolhasb)
mnn_b.config(width = 18)

lbTU_b = Label(frBerthelot, text = "Temperature")
...
btCalcularBerthelot = Button(frBerthelot, text = "Calculate", width = 18)
...
lbUnidades_vdw = Label(frVanDerWaals, text = "Select input units")

lbPU_vdw = Label(frVanDerWaals, text = "Pressure")
...
lbnU_vdw = Label(frVanDerWaals, text = "Moles")
mnn_vdw = OptionMenu(frVanDerWaals, tkn_vdw, *escolhasvdw)
mnn_vdw.config(width = 18)

lbTU_vdw = Label(frVanDerWaals, text = "Temperature")
...
btCalcularVanDerWaals = Button(frVanDerWaals, text = "Calculate", width = 18)
...
lbUnidades_fc = Label(frFatorCompressibilidade, text = "Select input units")

lbPU_fc = Label(frFatorCompressibilidade, text = "Pressure")
...
lbnU_fc = Label(frFatorCompressibilidade, text = "Moles")
mnn_fc = OptionMenu(frFatorCompressibilidade, tkn_fc, *escolhasfc)
mnn_fc.config(width = 18)

lbTU_fc = Label(frFatorCompressibilidade, text = "Temperature")
...
btGerarGraficoFatorCompressibilidade = Button(frFatorCompressibilidade, text = "Generate", width = 18)
...
lbUnidades_isot = Label(frIsotermas, text = "Select input units")

lbPU_isot = Label(frIsotermas, text = "Pressure")
...
lbnU_isot = Label(frIsotermas, text = "Moles")
mnn_isot = OptionMenu(frIsotermas, tkn_isot, *escolhasiso)
mnn_isot.config(width = 18)

lbTU_isot = Label(frIsotermas, text = "Temperature")
...
btGerarGraficoIsotermas = Button(frIsotermas, text = "Generate", width = 18)
...
btFatoresCompressibilidade = Button(frToolBar, text = "Compressibility Factors", width = 25)
btFatoresCompressibilidade["command"] = partial(escolhaTela, "FatoresCompressibilidade")
btIsotermas = Button(frToolBar, text = "Isotherms", width = 25)
